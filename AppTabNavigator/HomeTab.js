...
static navigationOptions = {
  ...
  render() {
    return (
     ...
     <Body style={{ alignItems:'center' }}><Text style={{ paddingLeft: 50 }}>Instagram</Text></Body>
    ...
    <View style={{ flex: 3 }}>
      ...
      >
        ...
        <Content>
          <CardComponent imageSource="1" likes="53" />
          <CardComponent imageSource="2" likes="85" />
          <CardComponent imageSource="3" likes="29" />
          <CardComponent imageSource="4" likes="103" />
        </Content>
